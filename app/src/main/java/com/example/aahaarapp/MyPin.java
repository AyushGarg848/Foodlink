                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (document.contains("location") && document.contains("name") && document.contains("phone") && document.contains("userid")) {
                                    ...
                                    if (Objects.equals(type, "Donor") & Objects.equals(Userid, userID)) {
                                    ...
                                    } else if (Objects.equals(type, "Receiver") & Objects.equals(Userid, userID)) {
                                        String snippet = "Phone: " + phone + "\n" +
                                                "Description: " + description;
